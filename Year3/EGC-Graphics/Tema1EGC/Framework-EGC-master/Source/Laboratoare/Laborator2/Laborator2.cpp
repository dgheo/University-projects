...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 1, 1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 1, 1), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 1, 1), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0, 1), glm::vec3(1, 1, 1)),
	...
	}
	{
		...
		Mesh *Tetraedru = CreateMesh("Tetraedru", vertics, index);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(-1.5f, 0, 0), glm::vec3(0.25f));
	RenderMesh(meshes["Tetraedru"], shaders["VertexColor"], glm::vec3(1, 0.5f, 0), glm::vec3(0.25f));
	//RenderMesh(meshes["patrat"], shaders["VertexNormal"], glm::vec3(4, 0, 0));
